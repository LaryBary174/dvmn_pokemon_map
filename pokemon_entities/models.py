...
class Pokemon(models.Model):
    ...
    title_en = models.CharField('Имя на англ', max_length=100, blank=True, null=True)
    title_jp = models.CharField('Имя на японском', max_length=100, blank=True, null=True)
    image = models.ImageField('Изображение', blank=True, null=True)
    description = models.TextField('Описание', blank=True, null=True)
    previous_evolution = models.ForeignKey('self', verbose_name='Эволюционировал из', on_delete=models.SET_NULL,
